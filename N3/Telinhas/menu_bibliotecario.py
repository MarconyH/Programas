    ...
    def add_exemplares(self):
        ...
        def obter_texto():
            def remove():
                ...
                self.bibliotecario.numero_exemplares(adicionar, isbn)
                 # Valor da quantidade de exemplares
                
                ctk.CTkLabel(j, text=(f"Adicionou: {adicionar}"), font=("cooper black", 40), text_color="#000080").grid(row=11, column=0, columnspan=2, pady=20, padx=5)
...
#foi
    def edit_book(self):
        ...
        def obter_texto():
            ...
            livro = self.bibliotecario.pesquisa_livro(isbn)
